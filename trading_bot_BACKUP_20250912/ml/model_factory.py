...
from trading_bot.ml.lstm_model import create_lstm_model

# Handle TensorFlow import gracefully - make it lazy
HAS_TENSORFLOW = None
_tf = None

def _get_tensorflow():
    """Lazy import of TensorFlow to avoid mutex issues"""
    global HAS_TENSORFLOW, _tf
