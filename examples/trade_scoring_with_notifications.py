...
def main():
    ...
    if openai_api_key:
        logger.info("Using OpenAI GPT-4 for trade scoring")
        ...
        logger.info("OpenAI API key not found, using mock LLM client")
        # Use the mock client to avoid API costs
    ...
    logger.info(f"Initializing TelegramNotifier with chat ID: {telegram_chat_id}")
    ...
    # Send initial notification that we're starting
    telegram.send_message("🧠 <b>Starting GPT-4 Trade Evaluation</b>\n\nEvaluating AAPL breakout setup...")
