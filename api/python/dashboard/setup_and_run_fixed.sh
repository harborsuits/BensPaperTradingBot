...
# Create virtual environment in home directory to avoid path with colon
VENV_DIR="$HOME/.venvs/trading_dashboard"
...
if [ ! -d "$VENV_DIR" ]; then
    ...
    echo -e "${GREEN}Virtual environment created successfully at $VENV_DIR.${NC}"
fi
