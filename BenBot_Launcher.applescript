-- BenBot Launcher.applescript
-- This script launches the BenBot trading dashboard
...
on run
	...
	tell application "Terminal"
		activate
		do script "cd " & quoted form of projectPath & " && ./start_benbot.sh"
	end tell
	...
	tell application "Google Chrome"
		activate
		open location "http://localhost:3003?nocache=" & (do shell script "date +%s")
	end tell
